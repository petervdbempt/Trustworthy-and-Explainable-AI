...
from torchvision.models import ResNet50_Weights, get_model, resnet50, Wide_ResNet50_2_Weights
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        for param in model2.parameters():
            # Scale the noise so it doesn't destroy performance
    ...
    mask_pred = binarize_cam(images[0], 0.2)
    mask_rand = binarize_cam(images[1], 0.2)
